...
/// Generates the full Riverpod AI-guidance doc set (mirrors the crm_lite_sebl
/// reference project) into a freshly created project. Called only when the
/// selected state management is Riverpod.
class RiverpodAiDocsCreator {
  Future<void> create(String basePath) async {
    ...
    await _write('$basePath/.claude/scripts/setup_ide.sh', _scriptSetupIdeSh);
    ...
    final shellFiles = <String>[
      ...
      '$basePath/.claude/scripts/setup_ide.sh',
...
// ============================================================
// Embedded doc contents (verbatim mirror of crm_lite_sebl).
// ============================================================
...
final _settingsJson = r'''{
  "permissions": {
    "allow": [
      ...
      "mcp__flutter-skill__get_current_route",
      "mcp__flutter-skill__get_widget_tree",
      "mcp__flutter-skill__get_errors",
      "mcp__flutter-skill__inspect",
      "mcp__flutter-skill__tap",
      "mcp__flutter-skill__find_by_type",
      "mcp__flutter-skill__swipe",
      "mcp__flutter-skill__get_text_content",
      "mcp__flutter-skill__get_logs"
    ]
  },
  "hooks": {
    "PreToolUse": [
...
final _scriptSetupIdeSh = r'''#!/bin/bash
# ============================================================
# .claude/scripts/setup_ide.sh
#
